                ...
                <div class="card border-secondary">
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" name="kode_mata_pelajaran" value="{{ $jurusan->kode_mata_pelajaran }}" class="form-control" readonly>
                        </div>
                        <div class="mb-3">
                         ...
                         <div class="mb-3">
                            ...
                            <input type="number"name="semester" class="form-control" value="{{ $jurusan->semester }}"readonly>
                            </input>
