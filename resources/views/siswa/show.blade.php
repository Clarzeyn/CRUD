            ...
            <div class="col-md-12">
                ...
                <div class="card border-secondary">
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            <label for="">nis</label>
                            <input type="number" name="nis" value="{{ $siswa->nis }}" class="form-control" readonly>
                        </div>
                        <div class="mb-3">
                         ...
                         <div class="mb-3">
                            ...
                            <textarea type="textarea"name="alamat_siswa" class="form-control" readonly>{{ $siswa->alamat_siswa }}
                            </textarea>
